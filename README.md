...
For the steering angle PID, the values used for proportional, integral and derivative coefficients were `0.12, 0.0002, 1.5`, respectively.
For the speed PID `1, 0.0001, 0.2` was used.
